...
export class ExpressMiddleware {
  ...
  static attach(
    ...
    app.use(async (err, req, res, next) =>
      middleware.exceptionHandler.handleJsonParseError(err, req, res, next)
    );
    ...
    app.use(async (err, req, res, next) =>
      middleware.exceptionHandler.handleError(err, req, res, next)
    );

    // Everything else is a 404
    app.use(async (req, res) =>
      middleware.exceptionHandler.handleNotFound(req, res)
    );
  }
}
